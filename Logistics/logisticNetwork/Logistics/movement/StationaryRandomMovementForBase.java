 ...
 *  logisticNetworkにおいて、荷物の配送倉庫はこのMovementModelを利用。
 *  基本的にはStationaryRandomMovementと内容は変わらない。
 *  
 *  noted by matsutani
 */
public class StationaryRandomMovementForBase extends MovementModel{
	 ...
	 */
	public StationaryRandomMovementForBase(Settings s) {
		super(s);
	...
	//	coords[0] = MovementModel.rng.nextDouble()* super.getMaxX();
	//	coords[1] = MovementModel.rng.nextDouble()* super.getMaxY();
	 ...
	 */
	public StationaryRandomMovementForBase(StationaryRandomMovementForBase sm) {
		super(sm);
		this.loc = sm.loc;
	}
	...
	@Override
	public StationaryRandomMovementForBase replicate() {
		return new StationaryRandomMovementForBase(this);
	}
